            ...
            <div className="cart">
                ...
                <div className="content__items">
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img className="pizza-block__image" src="https://static.essensworld.com/images/goods/thumb/perfumeW.png" alt="Pizza" />
                        </div>
                        <div className="cart__item-info">
                        <h3>Духи еще такие</h3>
                            <p>0.5ml , вот такие</p>
                        </div>
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img className="pizza-block__image" src="https://kupiessens.ru/wa-data/public/shop/products/12/00/12/images/652/652.970.png" alt="Pizza" />
                        </div>
                        <div className="cart__item-info">
                            <h3>Духи такие</h3>
                            <p>0.5ml , вот такие</p>
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего покупок: <b>3 шт.</b> </span>
                        <span> Сумма заказа: <b>900 ₽</b> </span>
                    </div>
                    <div className="cart__bottom-buttons">
                        <Link to="/" className="button button--outline button--add go-back-btn">
                            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="https://kupiessens.ru/wa-data/public/shop/products/12/00/12/images/652/652.970.png">
